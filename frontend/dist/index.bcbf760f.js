...
class Eingabeformular {
    ...
    _datum_aktualisieren() {
        ...
        if (datums_input !== null) datums_input.valueAsDate = new Date();
    }
    _absenden_event_hinzufuegen(eingabeformular) {
        eingabeformular.querySelector("#eingabeformular").addEventListener("submit", (e)=>{
            ...
            if (formular_fehler.length === 0) {
                ...
                if (bestehende_fehlerbox !== null) bestehende_fehlerbox.remove();
                e.target.reset();
                this._datum_aktualisieren();
            } else {
                let fehler = new Fehler("Folgende Felder wurden nicht korrekt ausgef\xfcllt:", formular_fehler);
                fehler.anzeigen();
            }
        });
    }
...
//# sourceMappingURL=index.bcbf760f.js.map
